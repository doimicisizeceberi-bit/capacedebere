...
export default function CapsPage() {
  ...
  const clearAll = () => {
    ...
    setSort("id_desc");
    setPage(1);
    setMapIso2(""); // also clear map filter (local state)
  };
  ...
  useEffect(() => {
    const fetchCaps = async () => {
      ...
      try {
        ...
        // NEW: send rollup ISO2 filter to API
    ...
    fetchCaps();
  }, [page, limit, sort, beerQ, countryQ, sheetQ, mapIso2]);
  ...
  return (
    <main className="page">
    <h1 className="h1-display">🍺 Beer Caps</h1>
                ...
                <div className="th-filter">
                  ...
                  {beerFilter && (
                    <button
                      className="th-clear"
                      type="button"
                      onClick={() => setBeerFilter("")}
                      aria-label="Clear beer filter"
                    >
                      ✕
                    </button>
                  )}
              ...
              <React.Fragment key={cap.id}>
                ...
                >
                  ...
                  <td>{cap.cap_no}</td>
					<td>
					  <CountryCell
						name={cap.caps_country?.country_name_full}
						iso2={cap.caps_country?.iso2}
					  />
					</td>
                  <td>{cap.sheet ?? "-"}</td>
                  <td>
                  ...
                  <tr className="table-details-row">
                    <td colSpan={6}>
                      <div className="details-grid">
                        <div>
                          <span className="label">ID:</span> {cap.id}
                        </div>
                        <div>
